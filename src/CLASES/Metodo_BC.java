...
public class Metodo_BC {

	public void addToUniversalHashtable(int key, Productos_BE new1) {
       Creation.addinHashtable(key, new1);
    }

    public void removeFromUniversalHashtable(int key) {
